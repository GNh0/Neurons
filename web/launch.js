...
if (location.protocol === 'file:') {
  document.body.innerHTML = `<main style="min-height:100vh;display:grid;place-items:center;padding:32px;height:auto">
    <section style="max-width:660px;padding:40px;border:1px solid #30473f;border-radius:16px;background:#0b1720">
      ...
      <a class="primary" style="display:inline-block;margin:16px 0;text-decoration:none" href="http://127.0.0.1:8877/">실행 중인 관측실 열기 ↗</a>
      <p class="caption">기본 주소 127.0.0.1:8877 · 연결되지 않으면 먼저 실행 파일을 열어 주세요.<br>소스만 받은 경우 setup.ps1을 먼저 실행합니다. 지도와 자극 실험은 LLM 없이 사용할 수 있습니다.</p>
    </section></main>`;
} else {
